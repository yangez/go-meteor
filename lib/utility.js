// if game is not done (archived), is not marking dead, and has both players there
...
// are we marking dead on this game at this very moment?
markingDead = function(game) {
  // game.markedSchema gets cleared if we leave markedDead mode
  return (game.markedDead && !game.archived && game.markedSchema) ? true : false;
}
