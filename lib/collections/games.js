...
Games.deny({
  update: function(userId, game, fieldNames) {
    return (_.without(fieldNames, 'blackPlayerId', 'whitePlayerId', 'wgoGame', 'boardState', 'messages', 'archived', 'previousMarker', 'markedDead', 'markedSchema', 'originalBoardState').length > 0);
  }
})
