...
Games.deny({
  update: function(userId, game, fieldNames) {
    return (_.without(fieldNames, 'blackPlayerId', 'whitePlayerId', 'wgoGame', 'messages', 'archived', 'turnMarker', 'markedDead', 'markedSchema', 'deadMarkers', 'userAcceptedMD', 'lastActivityAt', 'endedAt' ).length > 0);
  }
})
