...
*/
	...
	/**
	 * Export positions for consumption by mongo
	 *
	 * @return array objects
	 */
   exportPositions: function() {
     var copy = this;
     var newStack = this.stack.map(function(position){
       var obj = {
         capCount: position.capCount,
	...
	/**
	 * Import positions again when fetched from mongo
	 *
	 * @return array positions
	 */
   importPositions: function() {
     var newPositions = this.stack.map(function(pos) {
       var position = new WGo.Position(pos.size);
       position.capCount = pos.capCount;
       position.color = pos.color;
       position.schema = pos.schema;
       return position;
     });
     this.stack = newPositions;
     return this;
   },
