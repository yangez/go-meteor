...
Games.deny({
  update: function(userId, game, fieldNames) {
    return (_.without(fieldNames, 'blackPlayerId', 'whitePlayerId', 'wgoGame', 'messages', 'archived', 'turnMarker', 'markedDead', 'markedSchema', 'userAcceptedMD', 'lastActivityAt', 'endedAt', 'originalBoardState').length > 0);
  }
})
